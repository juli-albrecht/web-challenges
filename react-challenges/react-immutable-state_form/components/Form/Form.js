...
setMountain((prevMountain) => ({...prevMountain, name: event.target.value}))
  }

  function handleAltitudeChange(event) {

    setMountain((prevMountain)=> ({...prevMountain, values: {...prevMountain.values, altitude: event.target.value}}))
  }

  function handleMountainRangeChange(event) {
        setMountain((prevMountain)=> ({...prevMountain, values: {...prevMountain.values, mountainRange: event.target.value}}))
