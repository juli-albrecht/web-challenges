...
function sumNumbers(numbers) {
  ...
  // TODO:
  /*
  1. Get every number in our array
  2. Add all numbers
  3. return sum
  */
}
...
words2.forEach((word) => const lenghtEach = word.length
console.log(lenghtEach));
// TODO:
/*
  1. Get the length of every word in the array
  2. Add all the length value of every word
  2.1 store in variable1
  3. Get number of entries in array (should be 10)
  3.1 store in Variable2
  4. divide the sum of all letters by number of entries in array with variable1 / variable2
  4.1 store in V3 
  5. return V3
  */
